package org.opennms.integration.camel;
...
import org.opennms.integration.camel.model.Alert;
...
public class AlarmForwarder implements AlarmLifecycleListener {
    ...
    private static final String UEI_PREFIX = "uei.opennms.org/camel-tt-apiPlugin";
