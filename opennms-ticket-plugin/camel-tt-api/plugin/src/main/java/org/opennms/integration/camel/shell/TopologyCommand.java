package org.opennms.integration.camel.shell;
...
import org.opennms.integration.camel.TopologyForwarder;
import org.opennms.integration.camel.model.Topology;

@Command(scope = "opennms-camel-tt-api", name = "push-topology", description = "Push the topology")
@Service
