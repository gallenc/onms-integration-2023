...
@Schema(name = "TroubleTicketDeleteEventPayload", description = "The event data structure")
@JacksonXmlRootElement(localName = "TroubleTicketDeleteEventPayload")
@XmlRootElement(name = "TroubleTicketDeleteEventPayload")
...
public class TroubleTicketDeleteEventPayload {

  @JacksonXmlProperty(localName = "troubleTicket")
  private TroubleTicket troubleTicket;

  public TroubleTicketDeleteEventPayload troubleTicket(TroubleTicket troubleTicket) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    TroubleTicketDeleteEventPayload troubleTicketDeleteEventPayload = (TroubleTicketDeleteEventPayload) o;
    return Objects.equals(this.troubleTicket, troubleTicketDeleteEventPayload.troubleTicket);
  }
  ...
  public String toString() {
    ...
    sb.append("class TroubleTicketDeleteEventPayload {\n");
