...
@Schema(name = "TroubleTicketStatusChangeEventPayload", description = "The event data structure")
@JacksonXmlRootElement(localName = "TroubleTicketStatusChangeEventPayload")
@XmlRootElement(name = "TroubleTicketStatusChangeEventPayload")
...
public class TroubleTicketStatusChangeEventPayload {

  @JacksonXmlProperty(localName = "troubleTicket")
  private TroubleTicket troubleTicket;

  public TroubleTicketStatusChangeEventPayload troubleTicket(TroubleTicket troubleTicket) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    TroubleTicketStatusChangeEventPayload troubleTicketStatusChangeEventPayload = (TroubleTicketStatusChangeEventPayload) o;
    return Objects.equals(this.troubleTicket, troubleTicketStatusChangeEventPayload.troubleTicket);
  }
  ...
  public String toString() {
    ...
    sb.append("class TroubleTicketStatusChangeEventPayload {\n");
